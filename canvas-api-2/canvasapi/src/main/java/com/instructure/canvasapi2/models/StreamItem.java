...
public class StreamItem extends CanvasModel<StreamItem> {
    ...
    public Date getUpdatedAtDate() {
        if (updatedAtDate == null) {
            updatedAtDate = APIHelper.stringToDate(updated_at);
        }
    ...
    public Date getGradedAt() {
        if (gradedAtDate == null) {
            gradedAtDate = APIHelper.stringToDate(graded_at);
        }
        return gradedAtDate;
    }
    ...
    public Date getSubmittedAt() {
        if (submittedAtDate == null) {
            submittedAtDate = APIHelper.stringToDate(submitted_at);
        }
    ...
    public void setConversation(Context context, Conversation conversation, long myUserId, String monologueDefault) {
        ...
        if(APIHelper.paramIsNull(context, conversation,monologueDefault)){
            return;
        }
