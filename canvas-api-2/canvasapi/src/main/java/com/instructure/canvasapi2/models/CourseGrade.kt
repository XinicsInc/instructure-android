 ...
 * prior to use.
 *
 * @isLocked - Represents the lock status of a course, this is different from isHideFinalGrades, as
...
data class CourseGrade(
        ...
        var noCurrentGrade: Boolean,
        var noFinalGrade: Boolean) : PaperParcelable {
    ...
    companion object {
        ...
        @JvmField val CREATOR = PaperParcelCourseGrade.CREATOR
    }
