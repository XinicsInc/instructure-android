...
class FileFolderUnitTest : Assert() {
    ...
    private fun testCommonAttributes(fileFolder: FileFolder) {
        ...
        Assert.assertNotNull(fileFolder.createdAt)
        Assert.assertNotNull(fileFolder.updatedAt)
        Assert.assertNotNull(fileFolder.unlockAt)
        Assert.assertNotNull(fileFolder.lockAt)
