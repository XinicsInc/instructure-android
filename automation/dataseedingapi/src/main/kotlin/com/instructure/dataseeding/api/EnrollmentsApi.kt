...
object EnrollmentsApi {
    ...
    fun enrollUserAsObserver(courseId: Long, userId: Long): EnrollmentApiModel
            = enrollUser(courseId, userId, OBSERVER_ENROLLMENT)

    fun enrollUserAsDesigner(courseId: Long, userId: Long): EnrollmentApiModel
            = enrollUser(courseId, userId, DESIGNER_ENROLLMENT)

    private fun enrollUser(courseId: Long, userId: Long, enrollmentType: String): EnrollmentApiModel {
