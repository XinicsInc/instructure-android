    ...
    companion object {
        ...
        fun setColorAndIcon(
            ...
            val (colorRes, iconRes) = when {
                type.startsWith("image") -> R.color.utils_attachmentColorImage to R.drawable.vd_utils_image
                type.startsWith("video") -> R.color.utils_attachmentColorVideo to R.drawable.vd_utils_media
                type.startsWith("audio") -> R.color.utils_attachmentColorAudio to R.drawable.vd_utils_audio
                else -> when (name.substringAfterLast(".")) {
                    "doc", "docx" -> R.color.utils_attachmentColorDoc to R.drawable.vd_utils_document
                    "txt", "rtf" -> R.color.utils_attachmentColorTxt to R.drawable.vd_utils_document
                    "pdf" -> R.color.utils_attachmentColorPdf to R.drawable.vd_utils_document
                    "xls" -> R.color.utils_attachmentColorXls to R.drawable.vd_utils_document
                    "zip", "tar", "7z", "apk", "jar", "rar" -> R.color.utils_attachmentColorZip to R.drawable.vd_utils_attachment
                    else -> R.color.utils_attachmentColorMisc to R.drawable.vd_utils_attachment
                }
            }
