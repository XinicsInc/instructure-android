...
class SettingsActivity : AppCompatActivity(), ZendeskDialogStyled.ZendeskDialogResultListener{
    ...
    override fun onTicketPost() {
        ...
        Toast.makeText(this@SettingsActivity, R.string.zendesk_feedbackThankyou, Toast.LENGTH_LONG).show()
    }
