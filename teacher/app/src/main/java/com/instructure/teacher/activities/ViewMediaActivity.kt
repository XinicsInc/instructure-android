    ...
    private fun setupToolbar() {
        ...
        mEditableFile?.let {
            ...
            toolbar.setupMenu(R.menu.menu_edit_generic) { _ ->
                ...
                RouteMatcher.route(applicationContext, Route(EditFileFolderFragment::class.java, mEditableFile!!.canvasContext, args))
            }
        }
        toolbar.setupCloseButton { onBackPressed() }
        ViewStyler.setToolbarElevationSmall(this, toolbar)
        ViewStyler.themeToolbar(this, toolbar, getColorCompat(R.color.mediaOverlayBackground), Color.WHITE)
    }
