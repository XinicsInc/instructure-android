...
class SpeedGraderQuizSubmissionFragment : Fragment() {
    ...
    private fun viewQuizSubmission() {
        val bundle = SpeedGraderQuizWebViewFragment.newInstance(mCourseId, mAssignmentId, mStudentId, mUrl).arguments
        RouteMatcher.route(context, Route(SpeedGraderQuizWebViewFragment::class.java, null, bundle))
    }
